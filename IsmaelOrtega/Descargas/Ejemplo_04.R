...
setwd("D:/BEDU/ArchivosCSV/") # Depende del usuario donde ubicar su wd
...
# head obtiene los primeros 6 filas y tail los ultimos 6 filas
...
#Poder observar de mejor forma nuestro DataFrame
